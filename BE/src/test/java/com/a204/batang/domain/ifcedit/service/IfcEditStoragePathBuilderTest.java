...
class IfcEditStoragePathBuilderTest {
    ...
    void buildSceneSnapshotStorageUrl_returnsExpectedPath() {
        ...
        assertThat(path).isEqualTo("projects/11111111-1111-1111-1111-111111111111/revisions/22222222-2222-2222-2222-222222222222/3d/snapshot.v1.json");
    }
    ...
    void buildValidationReportStorageUrl_returnsExpectedPath() {
        ...
        assertThat(path).isEqualTo("projects/11111111-1111-1111-1111-111111111111/jobs/33333333-3333-3333-3333-333333333333/steps/002/engine/validation-report.v1.json");
    }
    ...
    void buildTwoDPlannerOutputStorageUrl_returnsExpectedPath() {
        ...
        assertThat(path).isEqualTo("projects/11111111-1111-1111-1111-111111111111/jobs/33333333-3333-3333-3333-333333333333/steps/001/planner/2d-command.v1.json");
    }
    ...
    void buildThreeDPlannerOutputStorageUrl_returnsExpectedPath() {
        ...
        assertThat(path).isEqualTo("projects/11111111-1111-1111-1111-111111111111/jobs/33333333-3333-3333-3333-333333333333/steps/010/planner/3d-command.v1.json");
    }
}
