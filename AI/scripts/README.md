...
| `generate_front_diagonal_auto_background_masks.py` | front diagonal 뷰에서 집은 보호하고 외부 전체를 inpaint 대상으로 잡는 preview-only mask 생성기. |
| `run_front_diagonal_auto_background_inpaint.py` | front diagonal full-outside auto-background inpaint smoke 실행 스크립트. |
