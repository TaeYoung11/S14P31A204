"""공간 형상을 보정하거나 분리된 공간 계획을 재구성할 때 쓰는 계산을 제공한다."""
...
def build_isolated_resize_space_plan(
    *,
    ...
    local_polygon = _world_to_local_polygon(
        ...
        origin_x=target.get("x") or 0.0,
        origin_y=target.get("y") or 0.0,
        angle_deg=target.get("angle") or 0.0,
    )
