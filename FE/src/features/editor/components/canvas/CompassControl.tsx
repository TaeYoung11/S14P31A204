...
export function CompassControl({ rotationRadians }: CompassControlProps) {
  return (
    <div
      role="img"
      aria-label={`True north direction ${formatDegrees(rotationRadians)}`}
      className="pointer-events-none relative h-16 w-16 select-none rounded-full border border-[#D3DAE8] bg-white shadow-[0_10px_24px_rgba(15,23,42,0.14)]"
    >
