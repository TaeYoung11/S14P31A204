  ...
  return (
    <div className="p-4 flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-col gap-2">
          <div className="flex flex-col gap-1.5">
            <label className="text-[10px] font-bold text-[#ADB5BD]">너비 (W)</label>
          ...
          <div className="flex gap-2">
            <div className="flex-1 flex flex-col gap-1.5">
              <label className="text-[10px] font-bold text-[#ADB5BD]">길이 (D)</label>
              <div className="relative">
                <input 
                  type="text" 
                  value="2,400" 
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="relative">
          <select className="w-full h-9 pl-9 pr-8 rounded-xl bg-[#F8F9FD] border-none text-[11px] font-bold text-[#1C1C1E] appearance-none focus:outline-none cursor-pointer">
            <option>콘크리트</option>
            <option>목재</option>
            <option>벽돌</option>
          </select>
